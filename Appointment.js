                        ...
                        <View style={{flexDirection: 'column', marginTop:15,marginLeft:5,width:'100%'}}>
                            ...
                            <View style={{flexDirection:'row',marginTop:15}}>
                                ...
                                {item.reshedule_power == 1 && (
                                    ...
                                    <Button style={{fontSize:14,color:'#800000',fontFamily:'Poppins-Medium'}}
...
>
                                ...
                                {item.cancel_power == 1 && (
                                <Button style={{fontSize:14,color:'#FF0000',fontFamily:'Poppins-Medium'}}
