                 ...
                 <View style={{ flex: 1 ,marginLeft : 5,width:window.width - 10, backgroundColor: 'white',marginTop: 10,marginBottom:10,borderRadius:10}}>
                     ...
                     <View style = {{flexDirection:'row',width :'100%'}}>
                         ...
                         <View>
                             ...
                             <View style = {{marginLeft:12,backgroundColor:'#800000',borderRadius:4,width:40,height:20,marginTop:2,flexDirection:'row',justifyItems:'center',alignItems:'center'}}>
                                 <Image style = {{width :8 ,height :8,marginLeft:4,resizeMode:'contain'}}
                                        source={require('./star.png')}/>

                                 <Text style={{marginLeft : 5,fontSize : 8,marginTop:3,color :'white',fontFamily:'Poppins-Medium',}}>
                         ...
                         <View>
                             ...
                             <View style = {{flexDirection:'row',width:'100%'}}>
                                 <Text style={{marginLeft : 5,fontSize : 15,color :'black',fontFamily:'Poppins-Medium',width :'80%',marginTop:18}}>
                             ...
                             <View style = {{flexDirection:'row'}}>
                                 <Text style={{marginLeft : 5,fontSize : 12,color :'grey',height:40,fontFamily:'Poppins-Medium',width :window.width -100}}>
...
*/}
                             <View style = {{flexDirection:'row',justifyContent:'space-between'}}>
                                 ...
                                 <View>
                                     <Text style={{fontSize : 12,color :'black',fontFamily:'Poppins-Medium',}}>
                             ...
                             {item.can_book_doctor_free  == 0 &&(
                                 <Text style={{fontSize : 12,color :'#800000',fontFamily:'Poppins-Medium',}}>
                     ...
                     <Button
                         style={{padding:4,marginTop:14,fontSize: 15, color: 'white',backgroundColor:'#800000',marginLeft:'55%',width:'20%',height:34,fontFamily:'Poppins-Medium',borderRadius:12,marginBottom: 20}}
