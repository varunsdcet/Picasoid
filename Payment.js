...
{/*                            <View style={{flexDirection:'column',marginLeft:32,marginTop:18}}>
                    ...
                    <Button
                        style={{padding:4,marginTop:5,fontSize: 20,color:'#800000',marginLeft:'5%',width:'90%',height:40,fontFamily:'Poppins-Medium',borderRadius:4}}
                    ...
                    <Button
                        style={{padding:4,marginTop:40,fontSize: 20, color: 'white',backgroundColor:'#800000',marginLeft:'5%',width:'90%',height:40,fontFamily:'Poppins-Medium',borderRadius:4}}
                        styleDisabled={{color: 'red'}}
