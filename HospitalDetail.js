    ...
    render() {
        return (
            ...
            <View style={styles.container}>
                ...
                <TouchableOpacity style = {{position:'absolute',top:30}} onPress={() => this.props.navigation.goBack()
                }>
                <View style = {{marginLeft:20,flexDirection:'row'}}>
                    <Image style={{width:20, height:20, resizeMode:'contain', marginTop:3}} source={require('./back.png')}/>
                <Text style={{marginLeft:20,fontSize:23, color:'white'}}>{this.state.name}</Text>
                </View>
                </TouchableOpacity>
                <ScrollView style={styles.container} >
                    <View style={{flexDirection:'column'}}>
                    ...
                    <Button
                        style={{padding:4,marginTop:8,fontSize: 20, color: 'white',backgroundColor:'#800000',marginLeft:'5%',width:'90%',height:40,fontFamily:'Poppins-Medium',borderRadius:4}}
