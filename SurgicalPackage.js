            ...
            <TouchableOpacity onPress={() => this.selectedFirst(index)
                ...
                <View style={{ flex: 1 ,marginLeft : 5,width:window.width - 10, backgroundColor: 'white',
                    ...
                    <View style = {{flexDirection:'row',marginBottom:10}}>
                        ...
                        <Button
                            style={{padding:6,marginTop:'1%',fontSize: 15, color: 'white',backgroundColor:'#800000',marginLeft:'5%',width:window.width/2 - 50,height:35,fontFamily:'Poppins-Regular',borderRadius:4}}
