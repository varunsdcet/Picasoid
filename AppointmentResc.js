    ...
    calculateDay(date){
        ...
        fetch(url, {
            ...
            body: JSON.stringify({
                ...
                "id":GLOBAL.appointment_details.booking_id
    ...
    render() {
        ...
        return (
                ...
                <View style={styles.container}>
                    ...
                    <Button
                        style={{padding:5,marginTop:'20%',fontSize: 20, color: 'white',backgroundColor:'#800000',marginLeft:'5%',width:'90%',height:40,fontFamily:'Poppins-Medium',borderRadius:4}}
