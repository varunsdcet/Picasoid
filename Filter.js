...
<View style = {{flexDirection:'row',alignSelf:'center'}}>
    ...
    <Button
        ...
        APPLY
                        ...
                        <Button
                            style={{padding:4,marginTop:14,fontSize: 20, color: 'white',backgroundColor:'#800000',marginLeft:'5%',width:window.width/2 - 50,height:40,fontFamily:'Poppins-Medium',borderRadius:4}}
                            styleDisabled={{color: 'red'}}
                            onPress={() => this.login()}>
                            CLEAR
                        </Button>
