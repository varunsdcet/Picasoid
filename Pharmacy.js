            ...
            <SafeAreaView>
                <View style={styles.container}>
                    <KeyboardAwareScrollView>
                        ...
                        <View style = {{margin:10,width:window.width-20,backgroundColor:'white',cornerRadius:30}}>
                        <TextField
                            label= 'ADD PROBLEM'
                            value={phone}
                            lineWidth={ 0}
                        ...
                        <View >
                            ...
                            <Button
                                style={{padding:7,marginTop:18,fontSize: 20,borderWidth:1,borderColor:"#800000",color:"#800000",marginLeft:'5%',width:'90%',height:40,fontFamily:'Poppins-Medium',borderRadius:4}}
